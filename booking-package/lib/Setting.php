    ...
    class booking_package_setting {
        ...
        public function userFunctions() {
            ...
            $userFunctions = array(
                ...
                **/
                'lost_password' => array('name' => __('Enable "Lost Password" feature', 'booking-package'), 'value' => '0', 'isExtensionsValid' => 1, 'inputLimit' => 1, 'inputType' => 'CHECK', 'valueList' => array('0' => 'Enabled')), 
            );
        ...
        public function words() {
            ...
            $words = array(
                ...
                __('Calculation Method', 'booking-package'), 
                __('Expiration Date', 'booking-package'), 
                __('Duration Time', 'booking-package'), 
                __('Specify the Time Slots for Each Day of the Week', 'booking-package'), 
                __('Allow Selecting Multiple Options', 'booking-package'), 
                __('Select All Time Slots', 'booking-package'), 
                __('Additional Duration', 'booking-package'), 
                __('Update Order', 'booking-package'), 
                __('Extra Charges & Taxes', 'booking-package'), 
                __('Add New Item', 'booking-package'), 
                __('Return to Calendar', 'booking-package'), 
                __('Change Password', 'booking-package'), 
                __('Applicable Price Level', 'booking-package'), 
                __('Count Towards Availability Limit', 'booking-package'), 
                __('Enable Quantity-Based Price Adjustment for Services', 'booking-package'), 
                __('Enable Quantity-Based Price Adjustment for Extra Charges', 'booking-package'), 
                __('Coupon Usage', 'booking-package'), 
                __('Expiration Date', 'booking-package'), 
                __('Notify the Administrator', 'booking-package'), 
                __('Attach an iCalendar File in the Email', 'booking-package'), 
                __('For Customer', 'booking-package'), 
                __('For Administrator', 'booking-package'), 
                __('You can use the following shortcodes in the content editor.', 'booking-package'), 
                __('Set the Publication Date', 'booking-package'), 
                __('Email Address', 'booking-package'), 
                __('Recipient Email Address', 'booking-package'), 
                __('Sender Name', 'booking-package'), 
                __('Sending Email Address', 'booking-package'), 
                __('Calendar Status', 'booking-package'), 
                ...
                __('Send Booking Verification Code', 'booking-package'), 
                __('For Customers', 'booking-package'), 
                __('For Users', 'booking-package'), 
                __('Payment Methods', 'booking-package'), 
                __('Local Payment', 'booking-package'), 
                __('Preparation Time', 'booking-package'), 
                __('Display Remaining Slots on Calendar', 'booking-package'), 
                __('Display Remaining Slots per Time Slot', 'booking-package'), 
                __('Fixed Calendar', 'booking-package'), 
                __('Insert Booking Confirmation Page Before Completion Page', 'booking-package'), 
                __('Prevent Multiple Bookings', 'booking-package'), 
                __('Reminder Notification Time', 'booking-package'), 
                ...
                __('Insert Custom Page at Each Step', 'booking-package'), 
                __('Service Selection', 'booking-package'), 
                __('Booking Form', 'booking-package'), 
                __('Booking Confirmation Form', 'booking-package'), 
                __('Booking Completion Form', 'booking-package'), 
                __('%s Page', 'booking-package'), 
                __('Redirect After Booking', 'booking-package'), 
                __('Weekly Schedule Templates', 'booking-package'), 
                __('Select Multiple Days', 'booking-package'), 
                __('Available Slots', 'booking-package'), 
                __('Remaining Slots', 'booking-package'), 
                __('Add a Time Slot', 'booking-package'), 
                __('Set the Publication Date', 'booking-package'), 
                __('Add Booking Calendar', 'booking-package'), 
                __('Copy Booking Calendar', 'booking-package'), 
                __('Refresh Token', 'booking-package'), 
                __('Data Range', 'booking-package'), 
                __('Last %s Days', 'booking-package'), 
                __('Submission Date', 'booking-package'), 
                __('Update Status', 'booking-package'), 
                __('Select Booking Calendar Type', 'booking-package'), 
        ...
        public function getOptionsForHotelData(){
            ...
            $options = array(
                ...
                'range' => array('name' => __('Pricing Basis', 'booking-package'), 'value' => 'allDays', 'inputLimit' => 2, 'inputType' => 'RADIO', 'isExtensionsValid' => 1, 'isExtensionsValidPanel' => 0, 'valueList' => array('allDays' => __('Charge Once per Booking', 'booking-package'), 'oneBooking' => __('Charge Once per Booking', 'booking-package')), 'actions' => null),
