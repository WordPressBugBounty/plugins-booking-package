    ...
    class booking_package_setting {
        ...
        public function words() {
            ...
            $words = array(
                ...
                __('Add Time Slots', 'booking-package'), 
                __('Multiple Days', 'booking-package'), 
                __('Add Time Slots', 'booking-package'), 
                __('Multiple Days', 'booking-package'), 
                __('After the Specified Date', 'booking-package'), 
                __('Within the Specified Date', 'booking-package'), 
                __('Pause', 'booking-package'), 
                __('Deletion Type', 'booking-package'), 
                __('Delete and Block Slot', 'booking-package'), 
                __('Delete Instance', 'booking-package'), 
                __('This time slot is currently blocked and will not be automatically recreated. To allow recreation based on the "%s", use the \'Delete Instance\' option instead.', 'booking-package'), 
                __('Set Up Time Slots', 'booking-package'), 
                __('Day Before Public Holiday', 'booking-package'), 
                __('Public Holiday', 'booking-package'), 
                ...
                __('Enable "%s" Feature', 'booking-package'), 
                __('Lost Password', 'booking-package'), 
                __('This booking was paid via %s. Will the payment be refunded to the customer?', 'booking-package'), 
                __('Will emails be sent to both customers and admins?', 'booking-package'), 
                __('Add New User', 'booking-package'), 
                __('Custom Fields', 'booking-package'), 
                __('This booking was paid via %s. Will the payment be refunded to the customer?', 'booking-package'), 
                __('Will emails be sent to both customers and admins?', 'booking-package'), 
                __('Subscription Status', 'booking-package'), 
                __('Update My Subscription', 'booking-package'), 
                __('Cancel My Subscription', 'booking-package'), 
                __('Font Size', 'booking-package'), 
                __('Site Name', 'booking-package'), 
                __('Background Color', 'booking-package'), 
                __('Date Format', 'booking-package'), 
                __('Rates', 'booking-package'), 
