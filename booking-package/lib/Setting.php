    ...
    class booking_package_setting {
        ...
        public function words() {
            ...
            $words = array(
                ...
                __('Available Rooms', 'booking-package'), 
                __('Remaining Rooms', 'booking-package'), 
                __('Publication Date', 'booking-package'), 
                __('Booking Deadline', 'booking-package'), 
                __('Placeholder Text', 'booking-package'), 
                __('Use as %s Field', 'booking-package'), 
                __('Name', 'booking-package'), 
                __('Email', 'booking-package'), 
                __('Location', 'booking-package'), 
                __('Agreement (Terms/Privacy)', 'booking-package'), 
                __('Save User Input Values', 'booking-package'), 
                __('Number of Guests', 'booking-package'), 
                __('Display Text', 'booking-package'), 
                __('Extra Charge', 'booking-package'), 
                __('Pricing Basis', 'booking-package'), 
                __('Calculation Basis', 'booking-package'), 
                __('Charge per Day', 'booking-package'), 
                __('Charge Once per Booking', 'booking-package'), 
                __('Per Guest', 'booking-package'), 
                __('Per Room', 'booking-package'), 
                __('Extra Charge per Adult', 'booking-package'), 
                __('Extra Charge per Child', 'booking-package'), 
                __('Extra Charge per Room', 'booking-package'), 
                ...
                __('Closing Days', 'booking-package'), 
                __('Public Holidays', 'booking-package'), 
                __('Blocks List', 'booking-package'), 
                __('Paid Subscription', 'booking-package'), 
                __('Form Fields', 'booking-package'), 
